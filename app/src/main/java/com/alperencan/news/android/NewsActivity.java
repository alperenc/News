package com.alperencan.news.android;
...
import com.alperencan.news.android.adapter.ContentAdapter;
import com.alperencan.news.android.loader.NewsLoader;
import com.alperencan.news.android.model.Content;

import java.util.ArrayList;
import java.util.List;

public class NewsActivity extends AppCompatActivity implements LoaderCallbacks<List<Content>> {
    ...
    @Override
    public void onLoadFinished(Loader<List<Content>> loader, List<Content> newsItems) {
